const lessonValues = [{
  ...
  description: 'Η συνέχεια της πρώτης παράδοσης για την HTML.',
  syllabus: [
    'Φόρμες',
  ...
  description: 'Η συνέχεια της πρώτης παράδοσης για την CSS.',
  syllabus: [
    'Κλάσεις και ids',
    'Ψευδοκλάσεις',
  ...
  description: 'Η συνέχεια της πρώτης παράδοσης για την PHP.',
  syllabus: [
  ...
  description: 'Εισαγωγή στις βασικές έννοιες της MySQL.',
  syllabus: [
  ...
  description: 'Η συνέχεια της πρώτης διάλεξης για την MySQL.',
  syllabus: [
    'Ταξινόμηση',
    'Όρια',
    'NULL',
  ...
  description: 'Εισαγωγή στις βασικές έννοιες της JavaScript.',
  syllabus: [
